...
export const PAQUETE_DESCRIPTIONS = {
  ...
  'individual-familiar': { es: 'Fotografiamos bebés desde los 4 meses, hermanitos, familias completas y también adultos que quieren esa foto especial para ellos. Ya sea en estudio o al aire libre, creamos imágenes que cuentan tu historia tal como es.', en: 'Sessions for couples, families or individuals in studio or outdoors, with a warm and spontaneous style.' },
